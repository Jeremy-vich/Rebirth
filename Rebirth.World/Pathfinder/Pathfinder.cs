...
namespace Rebirth.World.Pathfinder
{
    public class Pathfinder
    {
        ...
        public void SetMap(Map map, bool useDiagonal)
        {
            ...
            for (int line = 0; line < 20; line++)
            {
                ...
                {
                    cell = currentMap.Template.Cells[id];
                    bool Mov = currentMap.Template.Cells[id].Mov;
        ...
        {
            CellWithOrientation[] newCells = new CellWithOrientation[index];
        ...
        private void Find(short startCellId, short destinationCellId)
        {
            ...
            {
                var nCell = new CellWithOrientation(currentCell.Id, currentCell.Location.x, currentCell.Location.y);
                cells.Insert(0, nCell);  
            ...
            {
                cells[i].SetOrientation(cells[i + 1]);
            }
            m_cells = cells;
        }
        ...
        private double PointWeight(Point point)
        {
            ...
            int speed = currentMap.Template.Cells[cellId].Speed;
            if (speed >= 0)
            {
