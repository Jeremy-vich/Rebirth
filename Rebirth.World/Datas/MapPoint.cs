...
using ICloneable = Rebirth.Common.Extensions.ICloneable;
...
namespace Rebirth.World.Datas
{
    public class MapPoint : ICloneable
    {
        ...
        public MapPoint(CellData cell)
        {
            this.m_cellId = (short)cell.Id;
            this.SetFromCellId();
        }
        ...
        public static MapPoint GetPoint(CellData cell)
        {
